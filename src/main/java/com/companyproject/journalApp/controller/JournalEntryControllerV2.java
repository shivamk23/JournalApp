...
import com.companyproject.journalApp.services.JournalEntryService;
...
public class JournalEntryControllerV2 {
    ...
    @GetMapping
    public ResponseEntity<?> getAllJournalEntriesOfUser() { // GET  localhost:8080/journal
    ...
    @PostMapping
    public ResponseEntity<JournalEntry> createEntry(@RequestBody JournalEntry myEntry) {  //  POST  localhost:8080/journal
        try{
            Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
            String userName = authentication.getName();
    ...
    public ResponseEntity<JournalEntry> getJournalById(@PathVariable ObjectId myId) {
        ...
        if(!collect.isEmpty()){
            ...
            if (journalEntry.isPresent()) {
                System.out.println("JournalEntry found: " + journalEntry.get());
